...
class PBS:
    def __init__(self,root):
        ...
        title = Label(self.root,text = "Parth Billing Software",image=self.icon_title,compound=LEFT, font=("times new roman", 40, "bold"),bg="#010c48",fg="white",anchor="w",padx=20).place(x=0,y=0,relwidth=1,height=70)
        ...
        #CLOCK
        self.label_clock = Label(self.root,text = "Welcome\t\t Date : DD-MM-YYYY\t Time : HH:MM:SS", font=("times new roman", 15),bg="#5d636d",fg="white")
        ...
        #FOOTER
        label_footer = Label(self.root,text = "Parth Billing System", font=("times new roman", 12),bg="#5d636d",fg="white").pack(side=BOTTOM,fill=X)
